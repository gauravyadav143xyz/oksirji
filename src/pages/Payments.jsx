...
function Payments() {
    ...
    // Updated UPI ID
    const upiID = "netc.34161FA820328AA2D1E62D40@mairtel"; // Updated UPI ID to use for payments
    ...
    // Payment URLs
    const phonePayUrl = `phonepe://pay?pn=kitchen-offers&pa=${upiID}&am=${payableAmount}&tn=pay_to_kitchen-offers&tr=&cu=INR&mc=&qrMedium=04`;
    const paytmUrl = `paytmmp://pay?pn=kitchen-offers&pa=${upiID}&am=${payableAmount}&tn=pay_to_kitchen-offers&tr=&cu=INR&mc=&qrMedium=04`;
    const gPayUrl = `phonepe://pay?pn=kitchen-offers&pa=${upiID}&am=${payableAmount}&tn=pay_to_kitchen-offers&tr=&cu=INR&mc=&qrMedium=04`;
